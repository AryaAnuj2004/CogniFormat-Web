...
"""
            ...
            server.quit()
            return True, "Verification OTP sent to your email inbox! Please check your spam folder as well."
    ...
    with dl_col_left:
        if not st.session_state.unlocked:
            ...
            if not st.session_state.otp_sent:
                ...
                st.caption("📥 **Note:** If you don't see the email in your primary inbox, please check your **Spam / Junk** folder.")
                    ...
                    st.markdown("""
                        <style>
                            ...
                            @keyframes fadeOutAndHide {
                                ...
                                90% { opacity: 1; max-height: 50px; margin-top: 10px; visibility: visible; }
                            ...
                            .prep-file-animated-container {
                                ...
                                font-weight: 600;
                                font-size: 0.9rem;
                                animation: fadeOutAndHide 11s forwards ease-in-out;
                                overflow: hidden;
                            }
                        </style>
